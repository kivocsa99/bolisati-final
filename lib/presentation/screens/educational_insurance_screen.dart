                                                                      ...
                                                                      Row(
                                                                        ...
                                                                        children: [
                                                                          Column(
                                                                            children: [
                                                                              const Text("age").tr(),
                                                                              Text(kid.age!.toString(), style: const TextStyle(fontSize: 15, color: Colors.grey)),
                                                                            ],
                                                                          ),
                                                                          Column(
                                                                            children: [
                                                                              const Text("childid").tr(),
                                                                              Text(kid.national_id_number!.toString(), style: const TextStyle(fontSize: 15, color: Colors.grey)),
                                                                            ],
                                                                          )
                                                                        ],
                                                                      ),
