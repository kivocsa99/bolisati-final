...
class DomesticInsuranceScreen extends HookConsumerWidget {
  final DomesticWorkersOrderModel? model;
  final String? id;
  final String? type;
  const DomesticInsuranceScreen({super.key, this.id, this.type, this.model});
                                ...
                                children: [
                                  Column(
                                    crossAxisAlignment:
                                        CrossAxisAlignment.center,
                                    children: [
                                      const Text("workername").tr(),
                                      Text(model!.worker_name!,
                                          style: const TextStyle(
                                              fontSize: 15, color: Colors.grey))
                                    ],
                                  ),
                                  Column(
                                    crossAxisAlignment: CrossAxisAlignment.end,
                                    children: [
                                      const Text("workerid").tr(),
                                      Text(model!.national_id_number!,
                                          style: const TextStyle(
                                              fontSize: 15, color: Colors.grey))
                                    ],
                                  )
                    ...
                    return neworder.when(
                        data: (data) {
                          return data.fold((l) {
                            ...
                            print("object");
                            DomesticWorkersOrderModel model = r;
                            return Stack(
                              children: [
                                context.locale.languageCode == "en"
                                    ? Positioned(
