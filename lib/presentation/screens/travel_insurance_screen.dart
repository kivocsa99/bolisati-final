...
class TravelInsuranceScreen extends HookConsumerWidget {
  final TravelOrderModel? model;
  final String? id;
  final String? type;
  const TravelInsuranceScreen({super.key, this.model, this.id, this.type});
