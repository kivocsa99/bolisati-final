...
TravelOrderDoneModel _$TravelOrderDoneModelFromJson(Map<String, dynamic> json) {
  return _TravelOrderDoneModel.fromJson(json);
}

/// @nodoc
mixin _$TravelOrderDoneModel {
  int? get customer_user_id => throw _privateConstructorUsedError;
  int? get company_id => throw _privateConstructorUsedError;
  String? get travel_insurance_id => throw _privateConstructorUsedError;
  ...
  @JsonKey(ignore: true)
  $TravelOrderDoneModelCopyWith<TravelOrderDoneModel> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $TravelOrderDoneModelCopyWith<$Res> {
  factory $TravelOrderDoneModelCopyWith(TravelOrderDoneModel value,
          $Res Function(TravelOrderDoneModel) then) =
      _$TravelOrderDoneModelCopyWithImpl<$Res, TravelOrderDoneModel>;
  @useResult
  $Res call(
...
/// @nodoc
class _$TravelOrderDoneModelCopyWithImpl<$Res,
        $Val extends TravelOrderDoneModel>
    implements $TravelOrderDoneModelCopyWith<$Res> {
  _$TravelOrderDoneModelCopyWithImpl(this._value, this._then);
    ...
    return _then(_value.copyWith(
      ...
      name: freezed == name
          ...
          : name // ignore: cast_nullable_to_non_nullable
              as String?,
      distination: freezed == distination
          ? _value.distination
          : distination // ignore: cast_nullable_to_non_nullable
              as String?,
...
/// @nodoc
abstract class _$$_TravelOrderDoneModelCopyWith<$Res>
    implements $TravelOrderDoneModelCopyWith<$Res> {
  factory _$$_TravelOrderDoneModelCopyWith(_$_TravelOrderDoneModel value,
          $Res Function(_$_TravelOrderDoneModel) then) =
      __$$_TravelOrderDoneModelCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {int? customer_user_id,
...
/// @nodoc
class __$$_TravelOrderDoneModelCopyWithImpl<$Res>
    extends _$TravelOrderDoneModelCopyWithImpl<$Res, _$_TravelOrderDoneModel>
    implements _$$_TravelOrderDoneModelCopyWith<$Res> {
  __$$_TravelOrderDoneModelCopyWithImpl(_$_TravelOrderDoneModel _value,
      $Res Function(_$_TravelOrderDoneModel) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$_TravelOrderDoneModel(
      customer_user_id: freezed == customer_user_id
          ? _value.customer_user_id
          : customer_user_id // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$_TravelOrderDoneModel implements _TravelOrderDoneModel {
  const _$_TravelOrderDoneModel(
  ...
  factory _$_TravelOrderDoneModel.fromJson(Map<String, dynamic> json) =>
      _$$_TravelOrderDoneModelFromJson(json);
  ...
  @override
  final String? travel_insurance_id;
  @override
  ...
  @override
  String toString() {
    return 'TravelOrderDoneModel(customer_user_id: $customer_user_id, company_id: $company_id, travel_insurance_id: $travel_insurance_id, travel_region_id: $travel_region_id, travel_order_status_id: $travel_order_status_id, travel_region_name: $travel_region_name, age_from: $age_from, age_to: $age_to, period_from: $period_from, period_to: $period_to, price: $price, name: $name, distination: $distination, birthdate: $birthdate, age: $age, start_date: $start_date, end_date: $end_date, period_of_stay: $period_of_stay, total: $total, updated_at: $updated_at, created_at: $created_at, id: $id, addons: $addons)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$_TravelOrderDoneModel &&
            ...
            (identical(other.distination, distination) ||
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$_TravelOrderDoneModelCopyWith<_$_TravelOrderDoneModel> get copyWith =>
      __$$_TravelOrderDoneModelCopyWithImpl<_$_TravelOrderDoneModel>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_TravelOrderDoneModelToJson(
      this,
    );
  }
}

abstract class _TravelOrderDoneModel implements TravelOrderDoneModel {
  const factory _TravelOrderDoneModel(
      {final int? customer_user_id,
      final int? company_id,
      final String? travel_insurance_id,
      final int? travel_region_id,
      ...
      final String? created_at,
      final int? id,
      final List<AddonsModel>? addons}) = _$_TravelOrderDoneModel;

  factory _TravelOrderDoneModel.fromJson(Map<String, dynamic> json) =
      _$_TravelOrderDoneModel.fromJson;
  ...
  int? get company_id;
  @override
  String? get travel_insurance_id;
  @override
